    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Резервные коды помогут восстановить доступ, если вы потеряете
                    устройство 2FA. Храните их в надёжном менеджере паролей.
                </CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <>
                                ...
                                <div className="text-muted-foreground text-xs select-none">
                                    <p id="regenerate-warning">
                                        ...
                                        только один раз для доступа к учётной
                                        записи. Если нужны новые коды, нажмите{' '}
