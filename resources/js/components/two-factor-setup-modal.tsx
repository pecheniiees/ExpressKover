    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'Двухфакторная аутентификация включена. Отсканируйте QR-код или введите ключ настройки в приложении для аутентификации.',
                buttonText: 'Закрыть',
            };
        }
        ...
        if (showVerificationStep) {
            ...
            title: 'Подтвердите код аутентификации',
                description:
                    'Введите шестизначный код из приложения для аутентификации',
        ...
        return {
            ...
            description:
                    'Чтобы завершить настройку, отсканируйте QR-код или введите ключ настройки в приложении для аутентификации',
            buttonText: 'Продолжить',
        };
